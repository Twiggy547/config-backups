...
myBorderWidth = 2
myWorkspaces    = ["\61728","\61612","\61884","\62354", "\61888", "\61948","\61502","\61501","\61564","\63553"]
...
myManageHook = composeAll . concat $
    ...
    -- my1Shifts = ["alacritty", "urxvt", "kitty"]
    -- my2Shifts = ["brave", "surf", "qutebrowser", "lynx"]
    -- my3Shifts = ["spotify"]
    -- my4Shifts = ["discord"]
    -- my5Shifts = ["Gimp"]
    -- my6Shifts = []
...
myKeys conf@(XConfig {XMonad.modMask = modMask}) = M.fromList $
  ...
  [ ((modMask, xK_e), spawn $ "alacritty -e vim" )
  , ((modMask, xK_d ), spawn $ "dmenu_run -i -h '30' -nb '#221a0f' -nf '#C2a383' -sb '#889b4a' -sf '#c2a383' -fn 'DejaVu Sans:Regular:pixelsize=14'")
  ...
  , ((modMask, xK_F1), spawn $ "rofi -show drun" )
  , ((modMask, xK_F2), spawn $ "alacritty -e vim" )
  , ((modMask, xK_F3), spawn $ "alacritty -e nano" )
  , ((modMask, xK_F4), spawn $ "geany" )
  , ((modMask, xK_F5), spawn $ "vlc --video-on-top" )
  , ((modMask, xK_F6), spawn $ "gimp" )
  , ((modMask, xK_F7), spawn $ "xfce4-appfinder" )
  , ((modMask, xK_F8), spawn $ "thunar" )
  , ((modMask, xK_F9), spawn $ "rofi-theme-selector" )
  , ((modMask, xK_F10), spawn $ "arcolinux-tweak-tool" )
  , ((modMask, xK_F11), spawn $ "polybar-msg cmd toggle" )
  , ((modMask, xK_F12), spawn $ "$HOME/.xmonad/scripts/picom-toggle.sh" )
  ...
  , ((modMask .|. shiftMask , xK_l ), spawn $ "arcolinux-logout")
...
--  , ((0, xF86XK_AudioStop), spawn $ "playerctl stop")
  ...
  --Focus selected desktop
  , ((controlMask .|. modMask , xK_j ), prevWS)

  --Focus selected desktop
  , ((controlMask .|. modMask , xK_k ), nextWS)
  ...
  , ((controlMask .|. shiftMask, xK_Left), sendMessage (IncMasterN 1))

  -- Decrement the number of windows in the master area.
  , ((controlMask .|. shiftMask, xK_Right), sendMessage (IncMasterN (-1)))
